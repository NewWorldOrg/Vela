...
const THE_SUITE = [
  ...
  'repository/reservation-outcomes.test.ts',
  'repository/reservations.test.ts',
  'repository/rules.test.ts',
  'repository/said.test.ts',
