  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="absolute top-[9px] right-2.5 inline-flex size-[27px] items-center justify-center rounded-full border border-line text-ink-2 transition-[background-color,color,transform] duration-150 ease-toy hover:-rotate-6 hover:bg-surface-2 hover:text-ink focus-visible:shadow-ring focus-visible:outline-hidden disabled:pointer-events-none">
