                  ...
                  >
                    ...
                    >
                      ...
                      <span className="min-w-0 flex-1">
                        <span
                          className={cn(
                            'block text-ui font-bold [overflow-wrap:anywhere]',
                            on && 'text-brand',
                          )}
                        >
                          {channel.name}
                        ...
                        {channel.now ? (
                          <span className="block text-sub text-ink-2 [overflow-wrap:anywhere]">
                            {channel.now.title}
                          </span>
                        ) : (
                        ...
                        {channel.next && (
                          <span className="mt-px block text-note text-ink-3 [overflow-wrap:anywhere]">
                            次{' '}
